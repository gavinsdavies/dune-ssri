...
void draw_upd(std::string filename) {
  ...
  for (int i = 0; i < nEntries; ++i) {
    ...
    box4->SetLineStyle(kDashed);
    TBox *box4_full = new TBox(0, -150, 510, 150);
    box4_full->SetLineColor(kGreen);
    TBox *box4_TMS = new TBox(730.8, -235+50, 1365, 90-50);
    box4_TMS->SetLineColor(kRed);
    box4_TMS->SetLineStyle(kDashed);
    TBox *box4_TMS_full = new TBox(730.8, -235, 1415, 90);
    box4_TMS_full->SetLineColor(kGreen);
